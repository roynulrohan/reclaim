    ...
    <>
      ...
      >
        <div className="relative">
          <img
            src={heroImg}
            className="relative inset-x-0 z-0 mx-auto w-42.5"
            width="170"
            height="179"
            alt=""
          />
      ...
      <section
        id="next-steps"
        className="flex border-t border-(--border) text-left max-[1024px]:flex-col max-[1024px]:text-center"
      >
        <div
          id="docs"
        ...
        <div
          id="social"
          className="flex-[1_1_0] p-8 max-[1024px]:px-5 max-[1024px]:py-6"
        >
          <svg className="mb-4 size-5.5" role="presentation" aria-hidden="true">
          ...
          <ul className="m-0 mt-8 flex list-none gap-2 p-0 max-[1024px]:mt-5 max-[1024px]:flex-wrap max-[1024px]:justify-center">
            <li className="max-[1024px]:flex-[1_1_calc(50%-8px)]">
              ...
              >
                <svg
                  className="size-4.5 dark:filter-[invert(1)_brightness(2)]"
                  role="presentation"
                  aria-hidden="true"
                >
      ...
      <section
        id="spacer"
        className="h-22 border-t border-(--border) max-[1024px]:h-12"
      ></section>
    </>
  );
}
